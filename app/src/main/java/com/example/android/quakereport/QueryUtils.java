    ...
    public static ArrayList<Earthquakes> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++){
                ...
                long milltime = properties.getLong("time");
                String url = properties.getString("url");

                 Earthquakes earthquakess = new Earthquakes(mag,place,milltime,url);
                Earthquakes earthquake = new Earthquakes(mag, place,milltime, url);
                 earthquakes.add(earthquakess);
            }
